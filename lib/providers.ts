...
const selectedCalendarProvider=!isDemoMode()&&process.env.NEXT_PUBLIC_READY_CALENDAR_MODE==="live"?apiCalendarProvider:mockCalendarProvider;
const selectedWeatherProvider=!isDemoMode()&&process.env.NEXT_PUBLIC_READY_WEATHER_MODE==="live"?openMeteoWeatherProvider:mockWeatherProvider;
